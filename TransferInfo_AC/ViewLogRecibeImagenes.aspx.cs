...
{
    public partial class ViewLogRecibeImagenes : System.Web.UI.Page
    {
        public string tabla;
        ...
        protected void btnConsultaExp_Click(object sender, EventArgs e)
        {
            try
            {
                string PathExp = ConfigurationManager.AppSettings["PathLog_RECIBE_IMAGENES"].ToString();
        ...
        protected void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            {
                string PathExp = ConfigurationManager.AppSettings["PathLog_RECIBE_IMAGENES"].ToString();
                string archivo = PathExp.Replace("\\\\", "\\") + "\\Log_" + txtfecha.Text.Trim() + "\\Recibe_Imagenes.txt";
